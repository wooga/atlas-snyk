...
class SnykPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        def exampleTask = project.tasks.create("example", Snyk)
        exampleTask.group = "snyk"
        exampleTask.description = "example task"

    }

    protected static SnykPluginExtension create_and_configure_extension(Project project) {
