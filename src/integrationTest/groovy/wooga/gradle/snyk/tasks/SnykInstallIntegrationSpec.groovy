...
class SnykInstallIntegrationSpec extends IntegrationSpec {
    ...
    def "install snyk using plugin defaults"() {
        ...
        def expectedSnykFile = new File(String.join(File.separator, getUnixUserHomePath(), ".gradle", "atlas-snyk", "v1.840.0", (isWindows()? "snyk.exe" : "snyk")))
    ...
    def "installs given snyk version on target directory for macOS"() {
        ...
        "v1.839.0" | "snyk"    | null           | new File("snyk/v1.839.0/snyk") | "f3e5e31def231eb04d910c3cf0723c922c858fa1e9d1f2d1cdbd9099be878897"
    ...
    def "installs given snyk version on target directory for linux"() {
        ...
        where:
        version    | targetDir | executableName | expectedSnykExec               | expectedChecksum
        "v1.839.0" | "snyk"    | null           | new File("snyk/v1.839.0/snyk") | "5cd779adbef19c3c9982f01b672d5bd0e0005943a9dbb7038f8be772f70d1ddb"
        "v1.838.0" | "snyk"    | "snuk"         | new File("snyk/v1.838.0/snuk") | "c52363013e21413c65e6b839c5ff5355c3c4ffc12b168e9c365a63b0c09ea4c8"
    ...
    def "installs given snyk version on target directory for windows"() {
        ...
        where:
        version    | targetDir | executableName | expectedSnykExec                   | expectedChecksum
        "v1.839.0" | "snyk"    | null           | new File("snyk/v1.839.0/snyk.exe") | "6559946fa8270ad498d58fb5e75d0c55d014a70ac59383ea8440baefe2b2be7d"
        "v1.838.0" | "snyk"    | "snuk"         | new File("snyk/v1.838.0/snuk.exe") | "5178479ca737963048baf84bc151901d30047bee0e67b6d836766d22c981c016"
