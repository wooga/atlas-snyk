...
class SnykToHtmlInstallIntegrationSpec extends SnykInstallBaseIntegrationSpec<SnykToHtmlInstall> {
    ...
    String pluginInstallTaskName = "snykToHtmlInstall"
    File defaultInstallLocation = new File("${getGradleUserHome()}/atlas-snyk/snyk-to-html/latest/${isWindows() ? "snyk-to-html.exe" : "snyk-to-html"}")
