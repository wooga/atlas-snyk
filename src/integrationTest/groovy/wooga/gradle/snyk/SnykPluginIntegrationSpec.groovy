...
class SnykPluginIntegrationSpec extends SnykIntegrationSpec {
    ...
    def "sets convention for task type #taskType.simpleName and property #property"() {
        ...
        Test     | "packagesFolder"                 | "/path/to/packages1"                 | "Directory"                       | ConventionSource.extension(extensionName, property) | _
        Monitor  | "packagesFolder"                 | "/path/to/packages2"                 | "Directory"                       | ConventionSource.extension(extensionName, property) | _
    ...
    def "extension property :#property returns '#testValue' if #reason"() {
        ...
        "packagesFolder"                 | _                       | "/path/to/sarif1"                                               | _                                                                      | _                                           | PropertyLocation.environment
        "packagesFolder"                 | _                       | "/path/to/sarif2"                                               | _                                                                      | _                                           | PropertyLocation.property
        "packagesFolder"                 | toSetter(property)      | "/path/to/sarif3"                                               | _                                                                      | "Provider<Directory>"                       | PropertyLocation.script
        "packagesFolder"                 | toSetter(property)      | "/path/to/sarif4"                                               | _                                                                      | "File"                                      | PropertyLocation.script
        "packagesFolder"                 | toProviderSet(property) | "/path/to/sarif5"                                               | _                                                                      | "Provider<Directory>"                       | PropertyLocation.script
        "packagesFolder"                 | toProviderSet(property) | "/path/to/sarif6"                                               | _                                                                      | "File"                                      | PropertyLocation.script
        ...
        "initScript"                     | _                       | "/path/to/initScript_1"                                         | _                                                                      | _                                           | PropertyLocation.environment
        "initScript"                     | _                       | "/path/to/initScript_2"                                         | _                                                                      | _                                           | PropertyLocation.property
        "initScript"                     | toSetter(property)      | "/path/to/initScript_3"                                         | _                                                                      | "Provider<RegularFile>"                     | PropertyLocation.script
        "initScript"                     | toSetter(property)      | "/path/to/initScript_4"                                         | _                                                                      | "File"                                      | PropertyLocation.script
        "initScript"                     | toProviderSet(property) | "/path/to/initScript_5"                                         | _                                                                      | "Provider<RegularFile>"                     | PropertyLocation.script
        "initScript"                     | toProviderSet(property) | "/path/to/initScript_6"                                         | _                                                                      | "File"                                      | PropertyLocation.script
