...
class SnykPluginIntegrationSpec extends SnykIntegrationSpec {
    ...
    def "sets convention for task type #taskType.simpleName and property #property"() {
        ...
        Report   | "jsonOutputPath"                 | osPath("/path/to/json2")             | "RegularFile"                     | ConventionSource.extension(extensionName, property)              | _          || _
        Monitor  | "jsonOutputPath"                 | osPath("/path/to/json3")             | "RegularFile"                     | ConventionSource.extension(extensionName, property)              | _          || _
        ...
        Report   | "sarifOutputPath"                | osPath("/path/to/sarif2")            | "RegularFile"                     | ConventionSource.extension(extensionName, property)              | _          || _
        Monitor  | "sarifOutputPath"                | osPath("/path/to/sarif3")            | "RegularFile"                     | ConventionSource.extension(extensionName, property)              | _          || _
    ...
    def "extension property :#property returns '#testValue' if #reason"() {
        ...
        "autoUpdate"                     | _                       | _                                                               | true                                                                   | "Provider<Boolean>"                         | PropertyLocation.none
        "autoUpdate"                     | _                       | "true"                                                          | true                                                                   | _                                           | PropertyLocation.environment
        "autoUpdate"                     | _                       | "true"                                                          | true                                                                   | _                                           | PropertyLocation.property
        "autoUpdate"                     | toSetter(property)      | true                                                            | _                                                                      | "Provider<Boolean>"                         | PropertyLocation.script
        "autoUpdate"                     | toSetter(property)      | false                                                           | _                                                                      | "Boolean"                                   | PropertyLocation.script
        "autoUpdate"                     | toProviderSet(property) | true                                                            | _                                                                      | "Provider<Boolean>"                         | PropertyLocation.script
        "autoUpdate"                     | toProviderSet(property) | false                                                           | _                                                                      | "Boolean"                                   | PropertyLocation.script
